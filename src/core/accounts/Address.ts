...
export class Address {
   ...
   */
  static fromBech32(bech: string, prefix: string = AddressPrefix): Address {
    try {
   ...
   * @throws {Error} if bech is not a valid bech32-encoded address
   */
  static fromHex(hex: string, prefix: string = AddressPrefix): Address {
   ...
   * @returns {string}
   */
  toBech32(prefix: string = AddressPrefix): string {
