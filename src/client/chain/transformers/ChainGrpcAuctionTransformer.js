...
class ChainGrpcAuctionTransformer {
    static moduleParamsResponseToModuleParams(response) {
        ...
        return {
            auctionPeriod: parseInt((params === null || params === void 0 ? void 0 : params.auctionPeriod) || '0', 10),
            minNextBidIncrementRate: (params === null || params === void 0 ? void 0 : params.minNextBidIncrementRate) || '0',
        };
    }
