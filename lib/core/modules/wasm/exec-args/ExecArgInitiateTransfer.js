...
export default class ExecArgInitiateTransfer extends ExecArgBase {
    ...
    toData() {
        ...
        return Object.assign({ nonce: Math.round(Math.random() * 100000), asset: {
                ...
                info: params.info,
            }, recipient_chain: params.recipientChainId, recipient: binaryToBase64(params.recipient), fee: params.relayerFee || '0' }, (params.payload && { payload: binaryToBase64(params.payload) }));
    }
    toExecData() {
