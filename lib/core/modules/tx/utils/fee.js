...
import { DEFAULT_STD_FEE, DEFAULT_GAS_LIMIT, DEFAULT_GAS_PRICE, AddressPrefix, } from "../../../../";
import { BigNumberInBase, BigNumberInWei } from "@injectivelabs/utils";
export const getStdFeeForToken = (token = { denom: AddressPrefix, decimals: 18 }, gasPrice, gasLimit) => {
...
export const getStdFee = (args) => {
    ...
    return getStdFeeFromObject(Object.assign({}, args));
};
