...
export const createTransaction = (args) => {
    return createTransactionWithSigners(Object.assign(Object.assign({}, args), { signers: {
            pubKey: args.pubKey,
...
export const createTransactionFromMsg = (params) => {
    const messages = Array.isArray(params.message)
        ? params.message
        : [params.message];
    return createTransaction(Object.assign(Object.assign({}, params), { message: messages }));
};
/**
 ...
 * @returns
 */
export const createTransactionForAddressAndMsg = (params) => __awaiter(void 0, void 0, void 0, function* () {
    const messages = Array.isArray(params.message)
        ? params.message
        : [params.message];
    // Clients
    ...
    return createTransaction(Object.assign(Object.assign({}, params), { pubKey: params.pubKey || Buffer.from(baseAccount.pubKey.key).toString("base64"), sequence: Number(baseAccount.sequence), accountNumber: Number(baseAccount.accountNumber), timeoutHeight: timeoutHeight.toNumber(), message: messages }));
});
export const createTransactionAndCosmosSignDoc = (args) => {
    ...
    const [signer] = Array.isArray(result.signers)
        ? result.signers
        : [result.signers];
    return Object.assign(Object.assign({}, result), { cosmosSignDoc: CosmosTxV1Beta1Tx.SignDoc.fromPartial({
...
export const createTransactionAndCosmosSignDocForAddressAndMsg = (params) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield createTransactionForAddressAndMsg(params);
    const [signer] = Array.isArray(result.signers)
        ? result.signers
        : [result.signers];
    return Object.assign(Object.assign({}, result), { cosmosSignDoc: CosmosTxV1Beta1Tx.SignDoc.fromPartial({
