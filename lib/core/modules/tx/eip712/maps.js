...
export const mapValuesToProperValueType = (object, messageTypeUrl) => {
    ...
    return Object.keys(object).reduce((result, key) => {
        ...
        if (typeof value === 'object') {
            ...
            return Object.assign(Object.assign({}, result), { [key]: mapValuesToProperValueType(value) });
        }
        if (isNumber(value)) {
        ...
        if (typeof value === 'string') {
            if (sdkDecKeys.includes(key)) {
                return Object.assign(Object.assign({}, result), { [key]: numberToCosmosSdkDecString(value) });
            }
            // Message Type Specific checks
            if (messageTypeUrl) {
