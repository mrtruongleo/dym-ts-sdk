...
export const getEipTxContext = ({ accountNumber, sequence, fee, timeoutHeight, chainId, memo, }) => {
    return Object.assign(Object.assign({ account_number: Number(accountNumber), chain_id: chainId }, getEip712FeeV2(fee)), { memo: memo || '', sequence: Number(sequence), timeout_height: Number(timeoutHeight) });
};
