...
export default class MsgInstantBinaryOptionsMarketLaunch extends MsgBase {
    ...
    toProto() {
        ...
        const params = Object.assign(Object.assign({}, initialParams), { market: Object.assign(Object.assign({}, initialParams.market), { minPriceTickSize: amountToCosmosSdkDecAmount(initialParams.market.minPriceTickSize).toFixed(), makerFeeRate: amountToCosmosSdkDecAmount(initialParams.market.makerFeeRate).toFixed(), takerFeeRate: amountToCosmosSdkDecAmount(initialParams.market.takerFeeRate).toFixed(), minQuantityTickSize: amountToCosmosSdkDecAmount(initialParams.market.minQuantityTickSize).toFixed() }) });
