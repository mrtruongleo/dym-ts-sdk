...
export default class MsgSubmitProposalSpotMarketParamUpdate extends MsgBase {
    ...
    toProto() {
        ...
        const content = createSpotMarketParamUpdate(Object.assign(Object.assign({}, params), { market: Object.assign(Object.assign({}, params.market), { relayerFeeShareRate: amountToCosmosSdkDecAmount(params.market.relayerFeeShareRate).toFixed(), makerFeeRate: amountToCosmosSdkDecAmount(params.market.makerFeeRate).toFixed(), takerFeeRate: amountToCosmosSdkDecAmount(params.market.takerFeeRate).toFixed(), minQuantityTickSize: amountToCosmosSdkDecAmount(params.market.minQuantityTickSize).toFixed() }) }));
