...
export default class MsgSubmitProposalSpotMarketLaunch extends MsgBase {
    ...
    toProto() {
        ...
        const content = createSpotMarketLaunchContent(Object.assign(Object.assign({}, params), { market: Object.assign(Object.assign({}, params.market), { minPriceTickSize: amountToCosmosSdkDecAmount(params.market.minPriceTickSize).toFixed(), minQuantityTickSize: amountToCosmosSdkDecAmount(params.market.minQuantityTickSize).toFixed(), makerFeeRate: amountToCosmosSdkDecAmount(params.market.makerFeeRate).toFixed(), takerFeeRate: amountToCosmosSdkDecAmount(params.market.makerFeeRate).toFixed() }) }));
