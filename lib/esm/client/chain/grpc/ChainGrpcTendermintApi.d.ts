...
export declare class ChainGrpcTendermintApi extends BaseGrpcConsumer {
    ...
    fetchLatestBlock(): Promise<import("@injectivelabs/core-proto-ts/cjs/tendermint/types/block").Block | import("@injectivelabs/core-proto-ts/cjs/cosmos/base/tendermint/v1beta1/types").Block>;
}
